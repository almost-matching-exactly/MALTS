...
sns.lineplot(hue='Method',y='Mean Relative CATE Error (percentage)',x='#Units', data=df_err,style='Method',markers=True,linewidth=3.5,markersize=10)
...
plt.tight_layout()
fig.savefig('Figures/trendplot_multifold_malts_n.png')

# fig, ax = plt.subplots(figsize=(40,50))
# sns.boxenplot(hue='Method',y='Relative CATE Error (percentage)',x='#Units', data=df_err)
# plt.xticks(rotation=65, horizontalalignment='right')
# ax.yaxis.set_major_formatter(ticker.PercentFormatter())
# plt.tight_layout()
# fig.savefig('Figures/boxplot_multifold_malts_n.png')
 
# fig, ax = plt.subplots(figsize=(40,50))
# sns.violinplot(hue='Method',y='Relative CATE Error (percentage)',x='#Units', data=df_err)
# plt.xticks(rotation=65, horizontalalignment='right')
# ax.yaxis.set_major_formatter(ticker.PercentFormatter())
# plt.tight_layout()
# fig.savefig('Figures/violin_multifold_malts_n.png')

df_err.to_csv('Logs/CATE_Multifold_Est_Error_File_n.csv')
