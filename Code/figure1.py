...
violinplot(delt_genmatch,positions=[4])
##violinplot(delt_nelmead,positions=[2])
##violinplot(delt_sqp,positions = [3])
xticks([1,2,3,4],['MALTS','Causal Forest','Insane','GenMatch']) #,'FLAME','Nelder-Mead','SQP'])
...
#xticks([1,2,3],['MALTS','Causal Random Forest','FLAME']) 
