...
for i in range(0,len(p_imp_array)):
    for j in range(0,len(n_array)):
        ...
        data = dg.data_generation_dense_2(num_control, num_treated, num_cov_dense, num_covs_unimportant,rho=0)
        df, dense_bs, treatment_eff_coef = data
        X,Y,T = np.array(df[df.columns[0:num_covariates]]), np.array(df['outcome']), np.array(df['treated'])
        n,m = X.shape
        dftest,_,_ = dg.data_generation_dense_2(5000, 5000, num_cov_dense, num_covs_unimportant)
        ...
        tight_layout()
        fig.savefig('Figures/CATE_distancemetriclearning_insane_'+str(num_control)+'_'+str(num_treated)+'_'+str(num_cov_dense)+'_'+str(num_covs_unimportant)+'.jpg')
        ...
        ylabel('Predicted Treatment')
        tight_layout()
        fig.savefig('Figures/CATE_distancemetriclearning_MALTS_NonGradient_'+str(num_control)+'_'+str(num_treated)+'_'+str(num_cov_dense)+'_'+str(num_covs_unimportant)+'.jpg')
        ...
        tight_layout()
        fig.savefig('Figures/CATE_distancemetriclearning_MALTS_Err_Diam_'+str(num_control)+'_'+str(num_treated)+'_'+str(num_cov_dense)+'_'+str(num_covs_unimportant)+'.jpg')
         
        popt, pcov = curve_fit(func, diam, t_hat_cobyla)
        fig = figure(figsize=(10,10))
        rcParams.update({'font.size': 36})
        scatter(diam, t_hat_cobyla, alpha=0.1)
        plot(diam2, func(diam2, popt[0],popt[1],popt[2]), color="black", linestyle="dashed", linewidth=3.0)
        xlabel('1/Diameter of Matched group')
        ylabel('Predicted CATE')
        tight_layout()
        fig.savefig('Figures/CATE_distancemetriclearning_MALTS_Cate_Diam_'+str(num_control)+'_'+str(num_treated)+'_'+str(num_cov_dense)+'_'+str(num_covs_unimportant)+'.jpg')
...
#        utils.install_packages(StrVector(packnames))
        ...
        ylabel('Predicted Treatment')
        tight_layout()
        fig.savefig('Figures/CATE_distancemetriclearning_genmatch_'+str(num_control)+'_'+str(num_treated)+'_'+str(num_cov_dense)+'_'+str(num_covs_unimportant)+'.jpg')
        ...
        ylabel('Predicted Treatment')
        tight_layout()
        fig.savefig('Figures/CATE_distancemetriclearning_nearestmatch_'+str(num_control)+'_'+str(num_treated)+'_'+str(num_cov_dense)+'_'+str(num_covs_unimportant)+'.jpg')
        ##
...
#        
        ...
        ylabel('Predicted Treatment')
        tight_layout()
        fig.savefig('Figures/CATE_distancemetriclearning_BART_'+str(num_control)+'_'+str(num_treated)+'_'+str(num_cov_dense)+'_'+str(num_covs_unimportant)+'.jpg')
        ##
...
#        violinplot(delt_cem,positions=[4])
        ...
        tight_layout()        
        fig.savefig('Figures/violin_error_cates_'+str(num_control)+'_'+str(num_treated)+'_'+str(num_cov_dense)+'_'+str(num_covs_unimportant)+'.jpg')
